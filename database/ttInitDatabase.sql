...
(1, 'Dell Laptop', 112233445, 'New', 1, 'High-end gaming laptop', 'Laptops'),
...
(5, 'Sony PlayStation 5', 112233445, 'New', 1, 'Next-gen gaming console with 4K capabilities', 'Gaming Consoles'),
(6, 'HP Envy Laptop', 112233445, 'Used', 1, 'High-performance laptop with Intel i7 processor', 'Laptops'),
(7, 'LG OLED 65-inch TV', 112233445, 'New', 1, '55-inch OLED 4K smart TV with HDR', 'Televisions'),
(8, 'Nintendo Switch', 112233445, 'Used', 1, 'Hybrid gaming console from Nintendo', 'Gaming Consoles'),
(9, 'Apple MacBook Pro', 112233445, 'New', 1, 'MacBook Pro with M1 chip for professionals', 'Laptops'),
...
(13, 'Microsoft Surface Laptop', 112233445, 'Used', 1, 'Versatile laptop with touchscreen functionality', 'Laptops'),
(14, 'Razer Blade 15 Laptop', 112233445, 'New', 1, 'High-end gaming laptop with Nvidia RTX graphics', 'Laptops'),
(15, 'Canon EOS R5 Camera', 112233445, 'Used', 1, 'Mirrorless camera with 8K video recording', 'Cameras'),
(16, 'Fitbit Charge 5', 112233445, 'New', 1, 'Fitness tracker with health monitoring features', 'Wearables'),
